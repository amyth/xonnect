...
class JanusGraphBuilder {
    ...
    public void populate() {
          ...
          this.initGraph()
          println "Recruiter Nodes population successfully accomplished. Please hit Ctrl+C to exit." 
    }
...
graphBuilder.main("/Users/admin/Documents/scripts/json_data/recruiter.json", "conf/janusgraph-cassandra.properties")
