...
class JanusGraphBuilder {
    ...
    public void populate() {
          ...
          this.initGraph()
          println "Company Nodes population successfully accomplished. Please hit Ctrl+C to exit." 
    }
...
graphBuilder.main("/Users/admin/Documents/scripts/json_data/company.json", "conf/janusgraph-cassandra.properties")
