...
class JanusGraphBuilder {
    ...
    public void populate() {
          ...
          this.initGraph()
          println "Job Nodes population successfully accomplished. Please hit Ctrl+C to exit." 
    }
...
graphBuilder.main("/Users/admin/Documents/scripts/json_data/job.json", "conf/janusgraph-cassandra.properties")
